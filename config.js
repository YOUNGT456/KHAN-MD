...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY YOUNG T-MD 🤍*",
// set the auto reply massage on status reply  
PREFIX: process.env.PREFIX || "!",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "𝐘𝐎𝐔𝐍𝐆 𝐓-𝐌𝐃",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "𝐘𝐎𝐔𝐍𝐆 𝐓-𝐌𝐃",
...
LIVE_MSG: process.env.LIVE_MSG || "> Zinda Hun Yar *𝐘𝐎𝐔𝐍𝐆 𝐓-𝐌𝐃*⚡",
// add alive msg here 
